...
## upload to bintray
zip -r $dir/libogg-ogv.js.zip . 
curl -T $dir/libogg-ogv.js.zip -u$1:$2 https://api.bintray.com/content/daemoohn/libogg-ogv.js/libogg-ogv.js/$version/libogg-ogv.js.zip?publish=1
